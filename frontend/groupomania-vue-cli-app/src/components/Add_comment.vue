<template>
  ...
  <article class="row mt-5 pt-4 d-flex justify-content-center comment__view--colors addcomment--layout">
    ...
    <textarea name="Comment" id="Comment" v-model="post.comment" placeholder="Taper votre commentaire ici..." class="col-8" rows="5"></textarea>
    <div class="col-12">
