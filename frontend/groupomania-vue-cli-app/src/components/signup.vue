<template>
  ...
  <div id="Signup" class="mt-5">
    ...
    <form action="/Accueil">
      ...
      <label for="password" class="col-12 mt-4">Mot de passe (minimum 6 caractères)</label>
      <input for="password" type="password" id="password" class="col-12 col-md-6" minlength="6" required v-model="post.password"> <!-- copie les données dans le data post  -->
